...
def main():
    ...
    try:
        ...
        if (prompts_dir / "promptFXFixingData.txt").exists() and (prompts_dir / "contract.txt").exists():
            print("Loading promptFXFixingData.txt...")
            response = query_claude_with_prompt_file("promptFXFixingData.txt", "contract.txt")
